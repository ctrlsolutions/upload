<template>
  <div v-bind="$attrs" :style="{ width: width, height: height }" class="folder-container">
...
.rounded-tab {
  ...
  mask:
    radial-gradient(var(--r) at var(--r) 0, #0000 100%, #000 100%) calc(-1 * var(--r)) 100%/100% var(--r) repeat-x,
