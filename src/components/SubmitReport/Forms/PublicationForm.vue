<template>
    <div class="form">
      ...
      <div class="form-group">
        ...
        <base-select-input v-model="form.typeOfPublisher" :options="typeOfPublisher" />
      </div>

      <div class="form-group">
        <label>Location of Publisher</label>
        <BaseSelectInput v-model="form.locationOfPublisher" :options="[{value: 'local', label: 'Local'}, {value: 'international', label: 'International'}]" />
      </div>

      <div class="form-group">
        <label>Volume No. and Issue No.</label>
      ...
      <div class="form-group">
        ...
        <br><h4>PDF Image File 1: Proof of Publication or Accepted for Publication such as cover, title and bibliographic information pages, publisher's acceptance letter or preprint, etc.</h4> 
        <br><h4>PDF Image File 2: Proof of Utilization, if applicable, such as citation evidence, number of sales, UP International Publication Award, or was published in indexed/catalogued/recognized publications or by reputable publishers, etc., must be properly endorsed by the Dean/Head of Unit. If you have indicated a positive number of citations, please provide citation evidence for this publication.</h4>
      </div>
